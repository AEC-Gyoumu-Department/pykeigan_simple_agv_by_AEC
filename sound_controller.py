...
class SoundPlayer(threading.Thread):
    def __init__(self):
        super().__init__()
        self.file_path = ""
        self.normal_move_sound =  r"sound/normal_move.wav"
        self.blocked_move_sound = r"sound/blocked_move.wav"
        self.no_sound = ""
    ...
    def set_normal_move_sound(self):
        self.file_path = self.normal_move_sound

    def set_blocked_move_sound(self):
